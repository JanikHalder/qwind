    ...
    return (
            <>
                ...
                <div class="max-width-[1280px] p-10 bg-fourth text-white">
                  <h1 class="font-bold text-3xl pt-10 pb-5">Impressum und Offenlegung gemäß § 25 Mediengesetz</h1>
                  ...
                  <p>Berufsrecht: Versicherungsvermittlung in der Form Versicherungsagent. Gewerbeordnung: Abrufbar im Internet unter https://www.ris.bka.gv.at/</p>
                  ...
                  <h2 class="font-bold text-xl pt-10 pb-5">Technische Konzeption und Realisierung</h2>
                  <p>Janik Halder</p>
                  <a href="http://janikhalder.at/">janikhalder.at</a>


                  <h2 class="font-bold text-xl pt-10 pb-5">Urheberrechte/Haftungsausschluss</h2>
                  <div class="py-5">
