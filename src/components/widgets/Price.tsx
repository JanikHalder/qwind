...
export default component$(() => {
  ...
  function getYears$() {
    let allYears = [];
    let getTodayYear = dateState.datenow.getFullYear();
    ...
    <section class="bg-fourth">
      <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 class="mb-4 text-6xl tracking-tight font-extrabold text-white">
            Unsere Pakete
          </h2>
        </div>
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0 items-start">
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border shadow border-gray-600 xl:p-8 ">
            ...
            <p class="font-light text-gray-500 sm:text-lg mb-8">
              Das kleine Paket um seinen Bedüfnisse abzudecken
            </p>
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border shadow border-gray-600 xl:p-8">
            ...
            <p class="font-light text-gray-500 sm:text-lg mb-8">
              Unser Top - Seller. Das Paket für alle die …
            </p>
            <ul role="list" class="mb-8 space-y-4 text-left">
              <li class="flex items-center space-x-3">
                <svg
              ...
              <li class="flex items-center space-x-3">
                ...
                <span>
                  <span class="font-semibold">keine </span>finanzielle Belastung
                  der Hinterbliebenen
                </span>
              </li>
              <li class="flex items-center space-x-3">
            ...
            <button
              ...
              class="bg-third hover:bg-fourth focus:ring-4 focus:ring-primary-200 font-bold rounded-lg text-xl px-5 py-2.5 text-center text-white  "
            >
              Paket anfragen
            </button>
          </div>
