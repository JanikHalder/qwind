      ...
      <div class="container flex flex-col items-center px-4 py-12 mx-auto text-center">
        ...
        <div class="mt-6">
          <a
            href={Flyer}
            download
            class="inline-flex items-center justify-center w-full px-4 py-2.5 overflow-hidden text-sm text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700"
          >
            <span class="mx-2">Flyer Wiener Verein</span>
          </a>
          ...
          >
            <span class="mx-2">Servicekarte</span>
          </a>
        </div>
      </div>
    </section>
