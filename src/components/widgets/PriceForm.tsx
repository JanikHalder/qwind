  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex flex-row justify-center items-center">
        ...
        <input
          onChange={handleChange}
          onClick={() => (form.others = !form.others)}
          id="yellow-checkbox"
          type="checkbox"
          className="w-4 h-4 p-4 accent-third text-yellow-400 bg-gray-100 border-gray-300 rounded focus:ring-yellow-500 focus:ring-2"
        />
      </div>
      <div className="w-full flex justify-center items-center">
        <button className="text-white bg-third hover:bg-fourth focus:ring-4 focus:ring-primary-200 font-bold rounded-lg text-xl px-5 py-2.5 text-center ">
