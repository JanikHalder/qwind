      ...
      <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <div class="mt-4 md:mt-0">
          ...
          <p class="mb-6 font-light text-gray-500 md:text-lg">
            Ein Todesfall in der Familie stellt eine absolute Ausnahmesituation
            dar. Emotional – und in vielen Fällen auch finanziell! Ein Mensch
            verabschiedet sich endgültig und unwiderruflich. Und zurück bleibt
            Trauer und Ratlosigkeit. In dieser Situation ist es gut zu wissen,
            wohin man sich wenden kann. Der WIENER VEREIN hilft, rasch und
            unbürokratisch – durch einfühlsame Beratung, operatives Handeln und
            die sofortige Bereitstellung finanzieller Mittel.
          </p>
          <a
            href="#"
            class="inline-flex items-center text-white font-bold bg-third hover:bg-fourth focus:ring-4 focus:ring-primary-300 rounded-lg text-xl px-5 py-2.5 text-center mb-4"
          >
            Jetzt anfragen
            <svg
        ...
        <div class="relative rounded-xl overflow-hidden">
          ...
          <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <button
              ...
              id="playButton"
              class="flex items-center justify-center bg-third rounded-full h-16 w-16 transition duration-500 ease-in-out transform hover:scale-110"
            >
              <svg
                class="pl-1"
                width="30"
