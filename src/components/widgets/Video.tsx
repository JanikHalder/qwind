      ...
      <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        <div class="mt-4 md:mt-0">
          ...
          <p class="mb-6 font-light text-gray-500 md:text-lg">
            Wir bieten einfühlsame Beratung und schnelle finanzielle
            Unterstützung bei einem Todesfall in der Familie. Der WIENER VEREIN
            steht Ihnen in dieser Ausnahmesituation zur Seite.
          </p>
          <a
            href="/preise"
            class="inline-flex items-center text-white font-bold bg-third hover:bg-fourth rounded-lg text-xl px-5 py-2.5 text-center mb-4"
          >
            Jetzt anfragen
            <svg
