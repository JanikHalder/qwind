        ...
        <section class="bg-fourth">
            <div class="pt-24 grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:pt-32 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7 py-2">
                    ...
                    <p class="mb-6 pr-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">From checkout to global sales tax compliance, companies around the world use Flowbite to simplify their payment stack.</p>
