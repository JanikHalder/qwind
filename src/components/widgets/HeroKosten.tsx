    ...
    return (
        <section class="bg-fourth">
            <div class="py-16 pt-24 px-4 mx-auto max-w-screen-xl text-center lg:pt-32 lg:px-12">
                ...
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Wie teuer kommt eine Bestattung und welche versteckten Kosten gibt es.</p>
            </div>
        </section>
    )
});
