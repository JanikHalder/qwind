  ...
  const items = [
    [
      {
        ...
        description:
          "Der WIENER VEREIN ist der einzige echte Spezialist auf diesem Sektor und beschäftigt sich fast ausschließlich mit der umfassenden Vorsorge für den Todesfall.",
    ...
    [
      ...
      },
      {
        ...
        description: `Sofortschutz, Direktverrechnung mit Bestatter, lebenslanger Schutz, Ausrichtung der Bestattung nach persönlichen Wünschen – ob Feuer-,
      ...
      <div class="px-4 py-16 mx-auto max-w-6xl lg:px-8 lg:py-20">
        <div class="mb-10 md:mx-auto text-center md:mb-12 max-w-3xl">
          ...
          <p class="max-w-3xl mx-auto sm:text-center text-xl text-slate-400">
            Wir haben … Erfahrung im Bereich … und arbeiten mit unseren Kunden
            von …………
          </p>
        </div>
