    ...
    <section class="bg-fourth">
      <div class="container px-6 py-10 mx-auto max-w-screen-xl">
        <h2 class="text-2xl font-semibold lg:text-3xl text-white">
          Wir sind für sie da.
          <br />
          <span class="underline decoration-third">Unterstützung</span> über das
          finanzielle hinaus.
        </h2>
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-4">
          <div class="p-8 space-y-3 border-2 border-third rounded-xl flex items-center flex-col justify-center bg-white shadow-sm">
            <h3 class="text-xl font-semibold text-gray-700 uppercase">
              Ernstfall
            </h3>
            ...
            <p class="text-xl font-semibold text-gray-700 capitalize ">
              anrufen
            </p>
          </div>
          <div class="p-8 space-y-3 border-2 border-third rounded-xl flex items-center flex-col justify-center bg-white shadow-sm">
