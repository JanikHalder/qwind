    ...
    <section class="relative pt-24 pb-32 bg-white overflow-hidden">
      <div class="relative z-10 container px-4 mx-auto">
        ...
        <div class="flex flex-wrap -m-3">
          {content.map((people) => (
            <div
              class="w-full md:w-1/2 lg:w-1/3 p-3 rounded-sm"
              key={people.name}
            >
                  ...
                  <div class="mb-5 block">
                    <div class="flex flex-wrap mb-4 -m-2">
                      <div class="p-2 w-16 overflow-hidden rounded-full">
                        <img
                          src="https://media.istockphoto.com/id/1167753373/vector/woman-avatar-isolated-on-white-background-vector-illustration-for-your-design.jpg?s=612x612&w=0&k=20&c=Y2a_YXRjZ3bXa3Jn2EStSXv7hJly0uEkdlWk4tdbI6U="
                          alt=""
                        />
                      </div>
