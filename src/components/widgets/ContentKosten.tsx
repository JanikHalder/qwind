...
import KostenImage from "../../assets/images/kosten_bestattung.png";
      ...
      <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div class="font-light text-gray-500 sm:text-lg">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">
            Beispiel eines optimalen Angebots
          </h2>
          ...
          <div class="flex flex-row justify-between border-b-2">
            <p class="mb-4">
              Sarg, Aufbahrung, Bestattungsleistungen, Grabgebühren,
              Einäscherungsgebühr, etc.
            </p>
          </div>
          <div class="flex flex-row justify-between">
          ...
          <div class="flex flex-row justify-between border-b-2">
            <p class="mb-4">
              Totenmesse, Parten, Kränze, Trauerkleidung, Bewirtung der
              Trauergäste, etc.
            </p>
          </div>
          <div class="flex flex-row justify-between">
          ...
          <div class="flex flex-row justify-between border-b-2">
            <p class="mb-4">
              Steinmetzarbeiten (Grabstein, Grabinschrift), Notariatsgebühr,
              Grabpflege, neue Bestattungsformen (Erinnerungsdiamant,
              Edelsteine, Natur- oder Seebestattung etc.)
            </p>
          </div>
        </div>
        <div class="mt-8">
